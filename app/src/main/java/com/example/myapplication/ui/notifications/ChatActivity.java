...
public class ChatActivity extends AppCompatActivity {
 ...
 SharedPreferences preferences;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://192.168.197.21:5000/";
        ...
        }, 1,500);//schedule{TimerTask()方法调用，延时执行时间，循环执行时间间隔}
    ...
    private void insertChatRecord(MessageBean message) {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.197.21:5000/challenge/getmessage")
                .build();
...
//                                    // 对象设置的格式匹配。如果格式不正确，将引发 ParseException 异常。您可以尝试使用 try-catch 块来处理此异常。
                                    ...
                                    MessageBean messageBean = new MessageBean(key,message_from,to,message,formattedTime,challenge);
    ...
    public static void sendmessage(FormBody.Builder formBody, OkHttpClient client){
        ...
        Request request = new Request.Builder()//创建Request 对象。
                .url("http://192.168.197.21:5000/challenge/sendmessage")
